...
func TestNew(t *testing.T) {
	conn := getConnection()
	cache, err := NewSQLiteCache(conn, "autocert_cache")
...
func TestGet_UnkownKey(t *testing.T) {
	conn := getConnection()
	cache, _ := NewSQLiteCache(conn, "autocert_cache")
...
func TestDifferentTableName(t *testing.T) {
	conn := getConnection()
	cache, _ := NewSQLiteCache(conn, "cert_store")
